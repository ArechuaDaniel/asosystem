                ...
                <div className=' overflow-y-auto h-screen shadow-2xl md:w-4/5'>
                    ...
                    <div className="flex justify-between items-center m-10">
                        ...
                        <h1 className='text-sky-600 font-black md:text-3xl text-2xl'>
                            ...
                            Asociacion:  {auth.asociacion}
                        </h1>
                        <NavLink
                            className=''
                            to={'/asosystem/api/perfil'}>
                    ...
                    <NavLink 
                            to='/asosystem/api/clubes'
                            className="bg-green-500  hover:bg-green-600 hover:font-bold text-white cursor-default rounded-lg shadow-2xl ml-10 p-6  w-1/3">
                            <h3 className="md:text-3xl text-2xl flex flex-col items-center">Clubes  <span className="font-bold  md:text-7xl text-4xl">{clubes.length}</span></h3>
                        </NavLink>
                       
                        <NavLink 
                            to='/asosystem/api/alumnos'
