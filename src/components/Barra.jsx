...
const Barra = () => {
    const Links = [
        { name: "Home", link: "/asosystem/api/home", value: "dashboard" },
        { name: "Clubes", link: "/asosystem/api/clubes", value: "sports_gymnastics" },
        { name: "Intsructores", link: "/asosystem/api/instructores", value: "groups" },
        { name: "Alumnos", link: "/asosystem/api/alumnos", value: "groups" },
        { name: "Categorías", link: "/asosystem/api/alumnos", value: "category" },
        { name: "Campeonatos", link: "/asosystem/api/alumnos", value: "rewarded_ads" },
        //{ name: "Asensos", link: "/asosystem/api/asensos", value: "license" },
